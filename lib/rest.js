...
Rest.prototype.configure = function () {
  ...
  this.server.put(this.contextPath + 'user/:userId/:itemType/:itemId/:rating', function (req, res, next) {
    rest.putUserRating(req, res, next);
  });

  this.server.get(this.contextPath + 'user/:userId/:itemType/:itemId', function (req, res, next) {
